...
def main():
    ...
    layer_configs = parser.parse_cfg_file('yolov3_five.cfg')
    ...
    # shape of (in CHW format): -mc changes from [255,...] to [30,...]
    output_tensor_dims = OrderedDict()
    output_tensor_dims['082_convolutional'] = [30, 19, 19]
    output_tensor_dims['094_convolutional'] = [30, 38, 38]
    output_tensor_dims['106_convolutional'] = [30, 76, 76]
    ...
    output_file_path = 'yolov3_five.onnx'
